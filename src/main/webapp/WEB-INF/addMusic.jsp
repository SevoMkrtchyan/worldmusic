                ...
                <div class="profile-info row">
                    ...
                    <div class="profile-image col-xs-4">
                        <a href="ui-profile.html">
                            <img alt="" src="../adminpage/data/profile/profile-music.jpg"
        ...
        <div class="chat-wrapper">
            ...
            <ul class="group-list list-unstyled">
                <li class="group-row">
                    ...
                    <div class="group-info">
                        <h4><a href="mus-song-add.html#">Work</a></h4>
                    </div>
                </li>
                <li class="group-row">
                    ...
                    <div class="group-info">
                        <h4><a href="mus-song-add.html#">Friends</a></h4>
                    </div>
                </li>
            ...
            <ul class="contact-list">
                ...
                <li class="user-row " id='chat_user_1' data-user-id='1'>
                    <div class="user-img">
                        <a href="mus-song-add.html#"><img src="../adminpage/data/profile/avatar-1.png" alt=""></a>
                    </div>
                    <div class="user-info">
                        <h4><a href="mus-song-add.html#">Clarine Vassar</a></h4>
                ...
                <li class="user-row " id='chat_user_2' data-user-id='2'>
                    <div class="user-img">
                        <a href="mus-song-add.html#"><img src="../adminpage/data/profile/avatar-2.png" alt=""></a>
                    </div>
                    <div class="user-info">
                        <h4><a href="mus-song-add.html#">Brooks Latshaw</a></h4>
                ...
                <li class="user-row " id='chat_user_3' data-user-id='3'>
                    <div class="user-img">
                        <a href="mus-song-add.html#"><img src="../adminpage/data/profile/avatar-3.png" alt=""></a>
                    </div>
                    <div class="user-info">
                        <h4><a href="mus-song-add.html#">Clementina Brodeur</a></h4>
